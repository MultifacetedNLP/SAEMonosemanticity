...
from utility import tokenize_prompt_dataset, is_match, combine_defaultdicts, tokenize_prompt_word_dataset, convert_few_nerd_to_dict
    ...
    for start in tqdm(range(0, num_samples, batch_size), desc="Processing batches"):
        ...
        def hook_fn(activation: torch.Tensor, hook) -> torch.Tensor:
            ...
            for neuron in process_keys:
                activation[:, -1, neuron] *= dampening[neuron]
